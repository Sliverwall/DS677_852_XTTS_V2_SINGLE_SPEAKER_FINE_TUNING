...
if generate_button:
    if not text_prompt.strip():
        ...
        if selected_audio_name == "Benedict Cumberbatch":
            reference_audio_path = "<DIRECTORY>/datasets/Sherlock Holmes Stories  Read by Benedict Cumberbatch/wavs/chunk_0220.wav"
        elif selected_audio_name == "Tom Hanks":
            reference_audio_path = "<DIRECTORY>/Project/models/Tom Hanks/chunk_0009.wav"
        else:
