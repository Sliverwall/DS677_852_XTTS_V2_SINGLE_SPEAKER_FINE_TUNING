...
def get_example_audio() -> dict:
    ...
    """
    audio_mapping = {
        "Benedict Cumberbatch": r"<DIRECTORY>/run/training/Sherlock-Holmes-2-epochs-April-25-2025_03+08PM-0000000",
        "Tom Hanks": r"<DIRECTORY>/models/Tom Hanks"
    }
    ...
    for sample in user_samples:
        ...
        if sample not in audio_mapping:
            audio_mapping[sample] = "../XTTS-files/" # XTTS checkpoints directory
